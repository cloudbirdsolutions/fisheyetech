...
export default function TrendSelectorComponent(props: any) {
    ...
    } = useApi<ChartFieldValue>(`/charts/getchart?sheetId=${selectedSheetId}&fieldId=${selectedFieldId}&from=2024-06-07 09:04:58.633&to=2024-06-07 09:07:04.017`, { method: 'GET' });
    ...
    useEffect(() => {
        fetchFieldttributeList();
    }, [selectedSheetId, selectedFieldId]);
    ...
    const userSelectItems = [
        ...
        //     formHead: 'Value',
        //     name: 'value',
        //     selectList: fieldAttributeList,
        //     valueId: 'sheetId',
        //     optionLabel: 'recordMaster.fieldValue',
